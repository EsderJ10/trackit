...
const TEMPLATES: ProgramTemplate[] = [
    ...
    days: [
      {
        name: 'Workout A',
        exercises: [
          { exercise: 'Back Squat (Barbell)', scheme: 'lp', targetSets: 5, startingWeightKg: 40, startingReps: 5, incrementKg: 2.5 },
          { exercise: 'Bench Press (Barbell)', scheme: 'lp', targetSets: 5, startingWeightKg: 30, startingReps: 5, incrementKg: 2.5 },
          { exercise: 'Bent-Over Row (Barbell)', scheme: 'lp', targetSets: 5, startingWeightKg: 30, startingReps: 5, incrementKg: 2.5 },
        ],
      },
      {
        name: 'Workout B',
        exercises: [
          { exercise: 'Back Squat (Barbell)', scheme: 'lp', targetSets: 5, startingWeightKg: 40, startingReps: 5, incrementKg: 2.5 },
          { exercise: 'Overhead Press (Barbell)', scheme: 'lp', targetSets: 5, startingWeightKg: 20, startingReps: 5, incrementKg: 2.5 },
          { exercise: 'Deadlift', scheme: 'lp', targetSets: 1, startingWeightKg: 60, startingReps: 5, incrementKg: 5 },
        ],
      },
    ],
  },
    ...
    days: [
      {
        name: 'Push',
        exercises: [
          { exercise: 'Bench Press (Barbell)', scheme: 'dp', targetSets: 3, minReps: 6, maxReps: 10, startingWeightKg: 50, incrementKg: 2.5 },
          { exercise: 'Overhead Press (Barbell)', scheme: 'dp', targetSets: 3, minReps: 8, maxReps: 12, startingWeightKg: 30, incrementKg: 2.5 },
          { exercise: 'Tricep Pushdown (Cable)', scheme: 'dp', targetSets: 3, minReps: 10, maxReps: 15, startingWeightKg: 20, incrementKg: 2.5 },
        ],
      },
      {
        name: 'Pull',
        exercises: [
          { exercise: 'Bent-Over Row (Barbell)', scheme: 'dp', targetSets: 3, minReps: 6, maxReps: 10, startingWeightKg: 40, incrementKg: 2.5 },
          { exercise: 'Lat Pulldown (Cable)', scheme: 'dp', targetSets: 3, minReps: 8, maxReps: 12, startingWeightKg: 40, incrementKg: 2.5 },
          { exercise: 'Bicep Curl (Dumbbell)', scheme: 'dp', targetSets: 3, minReps: 10, maxReps: 15, startingWeightKg: 10, incrementKg: 2.5 },
        ],
      },
      {
        name: 'Legs',
        exercises: [
          { exercise: 'Back Squat (Barbell)', scheme: 'dp', targetSets: 3, minReps: 6, maxReps: 10, startingWeightKg: 60, incrementKg: 2.5 },
          { exercise: 'Romanian Deadlift', scheme: 'dp', targetSets: 3, minReps: 8, maxReps: 12, startingWeightKg: 50, incrementKg: 2.5 },
          { exercise: 'Leg Press (Machine)', scheme: 'dp', targetSets: 3, minReps: 10, maxReps: 15, startingWeightKg: 80, incrementKg: 5 },
        ],
      },
    ],
  },
  {
    ...
    days: [
      { name: 'Overhead Press', exercises: [fiveThreeOne('Overhead Press (Barbell)', 40, 2.5)] },
      { name: 'Deadlift', exercises: [fiveThreeOne('Deadlift', 100, 5)] },
      { name: 'Bench Press', exercises: [fiveThreeOne('Bench Press (Barbell)', 60, 2.5)] },
      { name: 'Squat', exercises: [fiveThreeOne('Back Squat (Barbell)', 80, 5)] },
    ],
  },
  {
    name: 'RPE Strength',
